...
const RichTextMainWrapper = ({ children }: { children: ReactChild }) => {
  return (
    <div className='flex-1
                prose prose-slate lg:prose-lg mt-6 
                prose-p:text-[16px] lg:prose-p:text-[17px]   prose-p:leading-8 
                prose-pre:bg-dim-dark prose-pre:text-[10px] sm:prose-pre:text-[12px] lg:prose-pre:text-[16px] prose-pre:w-[100%] prose-pre:aspect-auto
                ...
                prose-ul:leading-8 prose-ul:text-[16px] 
                prose-ol:leading-8 prose-ol:text-[16px]
                '>{children}</div>
  )
}
