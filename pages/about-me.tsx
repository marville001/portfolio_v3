    ...
    >
      <div className="bg-primary dark:bg-dim-dark">
        <div className="md-px-6 mx-auto max-w-[900px] bg-primary dark:bg-dim-dark py-10 px-2 sm:px-4">
          ...
          <div className="flex justify-center">
            <a href="/cv.pdf" target="_blank" rel="noopener noreferrer" download="Martin Resume"  className="rounded-md bg-dark dark:hover:bg-accent py-1.5 px-6 text-sm text-white">
                Download My CV
              </a>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-dark dark:text-white">
        <div className="mx-auto max-w-2xl py-12">
          <div className="">
            ...
            <p className="max-w-[600px] py-4 text-lg">
